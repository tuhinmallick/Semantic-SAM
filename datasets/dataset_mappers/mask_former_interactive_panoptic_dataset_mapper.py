...
from .coco_interactive_panoptic_new_baseline_dataset_mapper import filter_empty_instances_by_box


__all__ = ["MaskFormerPanopticDatasetMapperInteractive"]


class MaskFormerPanopticDatasetMapperInteractive(MaskFormerSemanticDatasetMapper):
    """
